...
本文件用于把 `imperial-agent-governance` 整理成一个适合公开分发，并可被 SkillsMP 收录的 skill 仓库。
...
```bash
git remote add origin https://github.com/<your-org>/imperial-agent-governance.git
...
- [ ] `README.md` 能说明 skill 的用途、入口和目录结构
- [ ] skill 引用的文件都已提交
- [ ] GitHub topics 已添加
- [x] 已选择并提交 `LICENSE`
...
2. 直接打开 `SKILL.md` 是否能看到正确的 frontmatter
3. `README.md` 是否清楚说明如何使用
4. SkillsMP 下一轮同步后是否能搜索到 `imperial-agent-governance`
