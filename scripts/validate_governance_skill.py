...
REQUIRED_FILES = [
    ...
    "skills/workflow-generic-governance/references/generic-governance.md",
    "skills/workflow-ppw/SKILL.md",
    "skills/workflow-sdd/SKILL.md",
    "skills/workflow-sdd/references/templates/00_INIT_CONTEXT.template.md",
    "skills/workflow-sdd/references/templates/00_EXPLORE.template.md",
    "skills/workflow-sdd/references/templates/00_PROPOSE.template.md",
    "skills/workflow-sdd/references/templates/01_SPEC.template.md",
    "skills/workflow-sdd/references/templates/07_ACCEPTANCE.template.md",
    "skills/workflow-sdd/references/templates/08_FINAL.template.md",
    "skills/workflow-sdd/references/templates/09_ARCHIVE.template.md",
]
